export const extract_opcode_name = opcode => {
    ...
    if (between(opcode, 0x5000, 0x5FFF)) return `SE V${x.toString(16)} V${y.toString(16)}`
    if (between(opcode, 0x6000, 0x6FFF)) return `LD V${x.toString(16)} 0x${nn.toString(16)}`
    if (between(opcode, 0x7000, 0x7FFF)) return `ADD V${x.toString(16)} 0x${nn.toString(16)}`
    ...
    if (between(opcode, 0x9000, 0x9fff)) return `SNE V${x.toString(16)} V${y.toString(16)}`;
    ...
    if (between(opcode, 0xd000, 0xdfff)) return `DRW V${x.toString(16)} V${y.toString(16)} ${n}`;
